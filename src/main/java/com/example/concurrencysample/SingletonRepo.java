...
public class SingletonRepo {
    ...
    //private HashMap<Integer, Concurrency> map = new HashMap<>();  // is not designed to be thread-safe
    ...
    public synchronized static SingletonRepo getInstance() {
        if (singletonrepo == null) {
            ...
            //.withCredentials(new AWSStaticCredentialsProvider(ac) )  // not recommended
            .build();
